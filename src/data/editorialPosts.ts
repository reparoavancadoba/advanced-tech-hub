...
Após a troca, realizamos testes de carga completa e monitoramos a temperatura para garantir funcionamento perfeito. ${LOCAL_SEO}`,
  ...
  },
  {
    ...
    metaDescription: "Face ID do iPhone parou? conserto focado com micro-soldagem do projetor de pontos em Salvador (Boca do Rio). diagnóstico gratuito!",
    category: "iphone" as Category,
    brand: "Apple",
    model: "iPhone",
  ...
  },
  {
    ...
    metaDescription: "Wi-Fi ou Bluetooth do iPhone não liga? Pode ser o chip de rádio. conserto de placa focado em Salvador (Boca do Rio). diagnóstico grátis!",
    category: "iphone" as Category,
    brand: "Apple",
    model: "iPhone",
  ...
  },
  {
    ...
    metaDescription: "Xiaomi ou Poco reiniciando sozinho? diagnóstico gratuito para identificar se é bateria, sistema operacional ou placa. Reparo Avançado - Boca.",
