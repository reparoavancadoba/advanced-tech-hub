...
export const locaisConsolidados: Record<string, LocalConsolidadoData> = {
  "salvador": {
    ...
    description: "Seja qual for o problema, a nossa assistência técnica celular atende toda a capital. Se você está buscando conserto de celular perto de mim em Salvador, temos o laboratório mais completo para reparos complexos na Boca do Rio.",
