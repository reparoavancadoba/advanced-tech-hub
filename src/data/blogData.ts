...
const services: ServiceDef[] = [
  {
    ...
    whenToSeek: "Procure oficina imediatamente se a tela apresentar qualquer rachadura, pois fragmentos de vidro podem causar lesões e umidade pode danificar componentes internos.",
  ...
  },
  {
    ...
    solution: "diagnóstico com microscópio profissional e conserto com estação de solda BGA. Recuperamos trilhas, substituímos CIs e componentes SMD.",
    whenToSeek: "Quando outra oficina disser que seu aparelho não tem conserto. Somos especialistas em recuperar o que outros não conseguem.",
    costInfo: "diagnóstico detalhado gratuito. Valor varia conforme complexidade do conserto.",
    appliesTo: ["iphone", "samsung", "xiaomi", "realme", "motorola", "notebooks"],
  },
  {
  ...
  },
  {
    ...
    causes: ["Queda com dano no sensor TrueDepth", "Troca de tela não autorizada", "Problema na placa"],
    solution: "diagnóstico completo do sistema TrueDepth e conserto ou substituição dos componentes necessários com reprogramação.",
    whenToSeek: "Quando a mensagem 'Face ID não está disponível' aparecer no seu iPhone.",
    costInfo: "Serviço focado. diagnóstico gratuito para avaliar a viabilidade do conserto.",
    appliesTo: ["iphone"],
  },
  {
    name: "Biometria",
  ...
  },
  {
    name: "Desoxidação",
    slug: "desoxidacao",
    description: "Tratamento químico avançado para aparelhos que tiveram contato com líquidos. restauração antes que a corrosão destrua os componentes.",
    ...
    whenToSeek: "IMEDIATAMENTE após o contato com líquido. Desligue o aparelho e NÃO tente ligar. Quanto mais rápido trouxer, maior a chance de restauração.",
  ...
  },
  {
    ...
    solution: "Formatação completa com backup de dados, reinstalação do sistema operacional e instalação otimizada.",
  ...
  },
  {
    ...
    description: "diagnóstico completo e conserto de aparelhos que não ligam. Recuperamos seu dispositivo com técnicas avançadas de microeletrônica.",
    problems: ["Aparelho totalmente morto", "Liga e desliga sozinho", "Fica na tela de boot", "LED acende mas não inicia"],
    causes: ["Problema na placa-mãe", "Bateria completamente esgotada", "Curto-placa", "Dano por líquido"],
    solution: "diagnóstico com equipamentos de precisão para identificar o componente defeituoso e conserto direcionado.",
    whenToSeek: "Quando seu aparelho parar de ligar completamente ou ficar preso na tela inicial.",
    costInfo: "diagnóstico gratuito. Só cobra se o conserto for aprovado.",
    appliesTo: ["iphone", "samsung", "xiaomi", "realme", "motorola", "notebooks"],
  },
  {
    name: "Aparelho Não Carrega",
    slug: "aparelho-nao-carrega",
    description: "diagnóstico e conserto de problemas de carregamento, desde o conector até o circuito de carga na placa.",
...
export const problemPosts: BlogPost[] = [
  ...
  return {
    ...
    h1: `${problem} em Salvador (BA), diagnóstico e conserto Profissional`,
    ...
    service: problem,
    serviceSlug: slug,
    description: `Solução profissional para ${problem.toLowerCase()} em Salvador. diagnóstico gratuito e conserto com peças premium na Boca do Rio.`,
    ...
    solution: `diagnóstico completo com equipamentos de precisão e conserto direcionado na Reparo Avançado.`,
    whenToSeek: "Procure um profissional qualificado assim que perceber o problema para evitar danos maiores.",
    costInfo: "diagnóstico 100% gratuito. Orçamento transparente antes de qualquer conserto.",
    relatedSlugs: [],
  };
});
...
import { editorialPostsBatch5 } from "./editorialPostsBatch5";
import { editorialPostsBatch6 } from "./editorialPostsBatch6";
