...
const services: ServiceDef[] = [
  ...
  },
  {
    ...
    description: "ajuste presencial presencial de baterias de alta performance que restauram a autonomia do seu aparelho. Saúde 100% de volta.",
  ...
  },
  {
    ...
    solution: "Formatação completa com backup de dados, reajuste presencial presencial do sistema operacional e ajuste presencial otimizada.",
...
const notebookServices: ServiceDef[] = [
  {
    ...
    solution: "ajuste presencial presencial de SSD NVMe com clonagem do sistema ou ajuste presencial presencial limpa do Windows/macOS. Seu notebook liga em segundos.",
  ...
  },
  {
    ...
    solution: "ajuste presencial presencial de módulos de RAM compatíveis com teste de estabilidade e performance.",
...
export const allPosts: BlogPost[] = [...editorialPosts, ...editorialPostsBatch2, ...editorialPostsBatch3, ...editorialPostsBatch4, ...editorialPostsBatch5, ...editorialPostsBatch6, ...editorialPostsBatch7, ...editorialPostsBatch8, ...problemPosts];
