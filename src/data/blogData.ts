...
const services: ServiceDef[] = [
  ...
  },
  {
    ...
    causes: ["Queda com impacto no placa", "Entrada de líquido", "Curto-circuito por carregador irregular", "Desgaste de componentes"],
  ...
  },
  {
    ...
    costInfo: "avaliação de urgência gratuito. O valor depende da extensão da oxidação.",
    appliesTo: ["iphone", "samsung", "xiaomi", "realme", "motorola"],
  },
  {
  ...
  },
  {
    ...
    causes: ["Problema no placa-mãe", "Bateria completamente esgotada", "Curto-placa", "Dano por líquido"],
  ...
  },
  {
    ...
    description: "avaliação e conserto de problemas de carregamento, desde o conector até o circuito de carga no placa.",
