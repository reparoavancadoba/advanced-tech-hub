...
export const editorialPostsBatch8: BlogPost[] = [
  ...
  },
  {
    ...
    metaDescription: "Seu celular diz 'Sem Serviço', 'Apenas Emergência' ou não reconhece o Chip SIM de jeito nenhum? Descubra se é defeito no leitor, antena interna ou.",
    category: "conserto",
    brand: "Geral",
    model: "Todos",
