...
export const editorialPostsBatch9: BlogPost[] = [
  ...
  },
  {
    ...
    metaDescription: "Seu celular está com toques fantasmas (mexendo sozinho) ou o touch parou de funcionar em uma letra do teclado? Descubra a causa e como a assistência resolve isso.",
    category: "conserto",
    brand: "Geral",
    model: "Todos",
  ...
  },
  {
    ...
    metaDescription: "Atualizou o sistema do seu Poco, Redmi ou Xiaomi e ele apagou, travou no Fastboot ou na tela MIUI? Entenda o que aconteceu e por que um reparo técnico salva o aparelho.",
    category: "xiaomi",
    brand: "Xiaomi",
