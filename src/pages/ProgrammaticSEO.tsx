      ...
      <section className="relative py-16 md:py-24 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-4 mt-10 text-sm font-semibold text-muted-foreground bg-secondary/50 py-3 px-6 rounded-2xl w-fit mx-auto border border-border/50">
