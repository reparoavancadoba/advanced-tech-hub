      ...
      <div className="container mx-auto px-4 py-16">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              <li className="flex items-start gap-2">
                ...
                Rua Exemplo, 123 - Boca do Rio, Salvador - BA, 41706-000
              </li>
        ...
        <div className="mt-12 rounded-xl overflow-hidden border border-border">
          <iframe
            ...
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3889.002!2d-38.4413!3d-12.9777!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTLCsDU4JzM5LjciUyAzOMKwMjYnMjguNyJX!5e0!3m2!1spt-BR!2sbr!4v1"
            width="100%"
            height="300"
            style={{ border: 0 }}
            allowFullScreen
