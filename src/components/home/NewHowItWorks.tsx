...
const NewHowItWorks = () => (
  <section className="bg-zinc-950 text-white py-12 md:py-16 lg:py-20 px-4 md:px-6 lg:px-8 border-b border-white/5 overflow-hidden">
      ...
      <div className="relative flex flex-col md:flex-row justify-between gap-6 md:gap-8 md:gap-0">
        ...
        {steps.map((step, i) => (
          <div key={i} className="relative z-10 flex flex-col items-center text-center max-w-[280px] mx-auto">
            <div className="w-24 h-24 bg-blue-600 rounded-full flex items-center justify-center text-white text-3xl font-black mb-6 shadow-xl border-8 border-zinc-950">
              {step.num}
            </div>
