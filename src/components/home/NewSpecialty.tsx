const NewSpecialty = () => (
  <section className="bg-zinc-950 text-white py-12 md:py-16 lg:py-20 px-4 md:px-6 lg:px-8 border-y border-white/5">
    <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-6 md:gap-8">
      ...
      <div className="flex-1 w-full">
        <div className="aspect-video bg-zinc-900 rounded-2xl overflow-hidden shadow-lg border border-white/10 flex items-center justify-center">
