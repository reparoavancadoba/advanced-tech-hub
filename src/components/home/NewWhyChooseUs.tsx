...
const NewWhyChooseUs = () => (
  <section className="bg-white text-zinc-900 py-10 md:py-16 lg:py-20 border-t border-zinc-100">
    <div className="max-w-6xl mx-auto">
      <h2 className="text-center md:text-left text-3xl md:text-4xl font-bold mb-10 md:mb-12 text-center">Por que escolher a <span className="text-[#0066FF]">Reparo Avançado</span></h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {reasons.map((r, i) => (
          <div key={i} className="flex flex-col items-center md:items-start text-center md:text-left gap-4 bg-zinc-50 p-8 rounded-2xl border border-zinc-200 hover:-translate-y-1 transition-transform shadow-sm hover:shadow-md">
