...
const NewWhyChooseUs = () => (
  <section className="bg-zinc-900 text-white py-12 md:py-16 lg:py-20 px-4 md:px-6 lg:px-8 border-t border-white/5">
    <div className="max-w-6xl mx-auto">
      <h2 className="text-3xl md:text-4xl font-bold mb-10 md:mb-12 text-center">Por que escolher a <span className="text-blue-500">Reparo Avançado</span></h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {reasons.map((r, i) => (
          <div key={i} className="flex flex-col gap-4 bg-zinc-950/50 p-8 rounded-2xl border border-white/5 hover:-translate-y-1 transition-transform">
            ...
            <h3 className="text-base md:text-lg font-semibold mb-2 text-blue-400">{r.title}</h3>
