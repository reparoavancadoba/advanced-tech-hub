...
const NewWhatWeDo = () => (
  <section id="servicos" className="bg-zinc-950 text-white py-12 md:py-16 lg:py-20 px-4 md:px-6 lg:px-8 bg-cover bg-center relative" style={{ backgroundImage: "url('/images/bg-circuit.png')" }}>
    <div className="max-w-6xl mx-auto text-center">
      <h2 className="text-3xl md:text-4xl font-bold mb-10 md:mb-12 text-center">O que fazemos</h2>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
        {services.map((svc, i) => (
          <div key={i} className="bg-zinc-900/40 backdrop-blur-md border border-white/10 p-6 md:p-8 rounded-2xl flex flex-col items-center justify-center gap-4 hover:border-blue-500/50 hover:bg-blue-900/20 group transition-all cursor-default">
            <svc.icon className="w-10 h-10 text-blue-500 group-hover:scale-110 transition-transform duration-300" />
