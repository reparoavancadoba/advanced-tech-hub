      ...
      <div className="container mx-auto px-4 h-20 flex items-center justify-between max-w-7xl relative">
        ...
        <div className="hidden md:flex items-center z-20 shrink-0">
          <a
            ...
            className="inline-flex items-center gap-2 bg-[#0066FF] text-white hover:bg-blue-600 px-5 py-2.5 rounded-lg text-sm font-semibold hover:shadow-lg hover:shadow-blue-600/20 transition-all"
          >
        ...
        <div className="md:hidden bg-[#0a0f18]/95 backdrop-blur-xl border-t border-white/10">
          <div className="container mx-auto px-4 py-4 flex flex-col gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 bg-[#0066FF] text-white hover:bg-blue-600 px-4 py-3 rounded-lg text-base font-semibold mt-2"
            >
